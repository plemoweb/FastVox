...
struct PathProducer
{
    PathProducer(SingleChannelSampleFifo<FastVoxAudioProcessor::BlockType>& scsf) :
...
struct ResponseCurveComponent : juce::Component,
    ...
    juce::Timer
{
    ResponseCurveComponent(FastVoxAudioProcessor&);
...
public:
    ...
    ~FastVoxAudioProcessorEditor() override;
...
private:
    ...
    Attachment peakFreqSliderAttachment,
        ...
        highShelfQualitySliderAttachment,
        lowCutFreqSliderAttachment,
        //highShelfFreqSliderAttachment,
        lowCutSlopeSliderAttachment;
        //highShelfSlopeSliderAttachment;

    std::vector<juce::Component*> getComps();

    PowerButton lowcutBypassButton, peakBypassButton, highShelfBypassButton;
